...
## Варіанти завдань
Перелік 30 індивідуальних варіантів винесено в окремий локальний файл:
`additional-course-materials/exam/Варіанти_іспит_мініпроєкт_GenAI_осінь_2025.md`.
Цей файл **не зберігається у репозиторії** (доданий у `.gitignore`).
